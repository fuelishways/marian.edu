<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Info.aspx.cs" Inherits="FindOutPages.Info" %>
   ...
   <head runat="server">
      ...
      <script>
         ...
         })(window, document, 'script', 'dataLayer', 'GTM-N4R8CJ9');
...
-->
         ...
         <section class="sectioncontainer dark intro" id="about">
            <div class="row column">
               <h2 class="sectionheading">Marian University Hires Leaders for Two-Year College</h2>
               <p>
                  <img class="imgfloatright" src="imgtwoyear/jeff-and-michael-directors.jpg" alt="marian hires executive director and dean"> Marian University has hired Jeffrey Jourdan to serve as executive director and Dr. Michael Nichols to serve as associate director and dean of its new two-year college. <br><br>
                  "In Jeffrey Jourdan and Michael Nichols, we have identified and hired two proven leaders with the requisite experience for launching our new, innovative, and mission-centered two-year college," Marian University President Daniel J. Elsener said. "Through their leadership, we will provide a much needed additional option for students who want to pursue higher education, but may not be ready for a traditional four-year college." <br><br>
                  <a href="https://marian.edu/newsroom/newsitem/2018/11/16/marian-university-hires-leaders-for-two-year-college" class="button hollow">Read the press release</a>
               </p>
            </div>
            <div class="row column">
