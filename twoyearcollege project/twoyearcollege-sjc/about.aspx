  ...
  <form id="form1" runat="server">
    ...
    <section class="sectioncontainer light" id="about">
      <div class="row column">
        ...
        <div style="margin-bottom: 2rem;" class="row column historycontainer" data-equalizer data-equalize-on="medium">
          <div class="row column">
        ...
        <div class="row column faqsection">
          ...
          <ul class="accordion" data-accordion>
            ...
            <li class="accordion-item is-activemu" data-accordion-item>
              ...
              <div class="accordion-content" data-tab-content>
                <p>On the campus of Marian University. All of your classes are in one building on campus, and all the amenities at Marian are available to you---Starbucks, state-of-the-art work out facilities, the library, the Writing Center, and more. </p>
              </div>
            </li>
            ...
            <li class="accordion-item is-activemu" data-accordion-item>
              ...
              <div class="accordion-content" data-tab-content>
                <p>Saint Joe Indy is a two-year college within Marian University. All classes are held on Marian's campus, students are a part of the Marian community, and, through Marian, we are accredited by the Higher Learning Commission (HLC). </p>
              </div>
            </li>
            ...
            <li class="accordion-item is-activemu" data-accordion-item>
              ...
              <div class="accordion-content" data-tab-content>
                <p>You can add a plug-in to your degree program. A plug-in allows you to take industry-specific elective courses within your degree program and work hands-on in your industry while in school. Plug-ins make you a more versatile and marketable without adding time to completing your two-year degree. Learn more about our information technology plug-in option. </p>
              </div>
            </li>
